...
| **Export to GitHub** (one-way mirror of app snapshots to a user-connected repo — ownership/portability trust feature; NOT our versioning engine, which stays snapshot-based) | Phase 2 accounts, or when Workers functions (#17) make apps code-heavy; two-way sync much later |
